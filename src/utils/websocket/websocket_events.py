...
async def emit_chat_message(conversation_id: int, message_data: dict, db=None):
    """Emit a chat message to participants in a conversation room."""
    await manager.broadcast_to_room(
        {"event": "new_message", "data": message_data},
